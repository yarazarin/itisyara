...
const App = () => {
    ...
    useEffect(() => {
        if (showPageX) return; // Don't initialize slider if PageX is shown
        ...
        const Slider = function (
            ...
            const btnClick = (e) =>
                gotoNum(parseInt(e.target.dataset.slide));
            ...
            pages.ontouchend = (e) => {
                ...
                const touchDifference = Math.abs(
                    touchstart - touchend
                );
    ...
    return (
        <>
            ...
            >
                <FirstPage onDoorClick={handleDoorClick} />
